...
def model_args():
    ...
    parser.add_argument('-lc', '--loss_coeff', type=float, default=0.001)
    ...
    parser.add_argument("--mode_freq", type=int, default=1, help="frequency (epochs) to switch between training modes")
    parser.add_argument("--objective_zeros", type=bool, default=False, help="train model with zeros for inactive modes")
    parser.add_argument('--data_path', type=str, default="data/raw", help="path to dataset")
    
    parser.add_argument('--num_frames', type=int, default=8, help="size of each training frame sequence (frames converted to attention maps)")
    parser.add_argument('--num_seq', type=int, default=4, help="number of total sequences - total frames = num_frames + num_seq")
    ...
    parser.add_argument('--attn_diff', type=bool, default=False, help="attention frames = diff(attn)")
